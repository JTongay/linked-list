...
var DoublyLinkedList = require("../doubly-linked");
...
describe("DoublyLinkedList", function() {
  ...
  xdescribe('getNodeAt', function () {
   it('Should return the node youre looking for', function () {

     list.push(1).push(2).push(3).push(7)
     expect(list.__getNodeAt(2).val).to.equal(2)
     expect(list.__getNodeAt(1).val).to.equal(1)
     expect(list.__getNodeAt(4).val).to.equal(7)
   })
  })
